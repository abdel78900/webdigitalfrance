      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Design innovant</Text>
            <Heading as="h3">
            Créez votre présence en ligne dès maintenant.
            </Heading>
            <Text as="p">
            Notre équipe utilise un code de qualité supérieure pour créer des sites web et des applications sur mesure qui correspondent à vos besoins uniques. Nous travaillons avec vous pour comprendre vos objectifs et créer une expérience en ligne qui dépasse vos attentes.
            </Text>
