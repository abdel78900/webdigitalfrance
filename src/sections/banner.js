    ...
    sx={styles.banner}>
      ...
      >
        <Image
          ...
          className="bannerIcon1"
          alt="banner icon"
          src={bannerIcon1}
        />
        <Image
          // sx={styles.bannerIcon2}
          className="bannerIcon2"
          alt="banner icon"
          src={bannerIcon2}
        />
        <Image
          // sx={styles.bannerIcon3}
          className="bannerIcon3"
          alt="banner icon"
          src={bannerIcon3}
        />
        <Image
        ...
        <Image
          ...
          className="bannerIcon5"
          alt="banner icon"
          src={bannerIcon5}
        />
        <Image
          // sx={styles.bannerIcon6}
          className="bannerIcon6"
          alt="banner icon"
          src={bannerIcon6}
        />
        <Image
          // sx={styles.bannerIcon7}
          className="bannerIcon7"
          alt="banner icon"
          src={bannerIcon7}
        />
